    ...
    <nav className="navbar">
      <div className="navbar-container">
        ...
        <div className="navbar-links">
          <Link to="/" className="navbar-link" onClick={handleLinkClick}>{t.home}</Link>
          <Link to="/about" className="navbar-link" onClick={handleLinkClick}>{t.about}</Link>
          <Link to="/services" className="navbar-link" onClick={handleLinkClick}>{t.services}</Link>
          <Link to="/testimonials" className="navbar-link" onClick={handleLinkClick}>{t.testimonials}</Link>
          <Link to="/contact" className="navbar-link" onClick={handleLinkClick}>{t.contacts}</Link>
        </div>
