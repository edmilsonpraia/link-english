    ...
    <footer style={{ 
      ...
      <div style={{ 
        ...
        <div style={{ 
          ...
          <a 
            href="https://chat.whatsapp.com/LfRQTTV9nvL30pzs0EKDNx" 
            target="_blank" 
            ...
            onMouseEnter={(e) => {
              ...
              e.target.style.boxShadow = '0 4px 12px rgba(37, 211, 102, 0.5)';
            }}
            onMouseLeave={(e) => {
          ...
          <a 
            href="https://www.tiktok.com/@linkenglish" 
            target="_blank" 
            rel="noopener noreferrer"
            title="TikTok"
            style={{ 
          ...
          <a 
            href="https://www.instagram.com/link_english.pt/profilecard/?igsh=MWFpNno3NWZwdm84Ng==" 
            target="_blank" 
            rel="noopener noreferrer"
            title="Instagram"
            style={{ 
              ...
              textDecoration: 'none',
              transition: 'all 0.3s ease',
              boxShadow: '0 2px 8px rgba(240, 148, 51, 0.3)'
            }}
            onMouseEnter={(e) => {
              e.target.style.transform = 'translateY(-2px)';
              e.target.style.boxShadow = '0 4px 12px rgba(240, 148, 51, 0.5)';
            }}
            onMouseLeave={(e) => {
              e.target.style.transform = 'translateY(0)';
              e.target.style.boxShadow = '0 2px 8px rgba(240, 148, 51, 0.3)';
            }}
          >
            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
          ...
          <a 
            href="https://youtube.com/@linkenglish-pt?si=bfMAnTabrOwOHCtV" 
            target="_blank" 
            rel="noopener noreferrer"
            title="YouTube"
            style={{ 
            ...
            onMouseEnter={(e) => {
              e.target.style.transform = 'translateY(-2px)';
              e.target.style.boxShadow = '0 4px 12px rgba(255, 0, 0, 0.5)';
            }}
            onMouseLeave={(e) => {
              e.target.style.transform = 'translateY(0)';
          ...
          <a 
            href="https://www.facebook.com/share/1FM8kjJiCr/?mibextid=wwXIfr" 
            target="_blank" 
            rel="noopener noreferrer"
            title="Facebook"
            style={{ 
            ...
            onMouseEnter={(e) => {
              e.target.style.transform = 'translateY(-2px)';
              e.target.style.boxShadow = '0 4px 12px rgba(24, 119, 242, 0.5)';
            }}
            onMouseLeave={(e) => {
              e.target.style.transform = 'translateY(0)';
          ...
          <a 
            href="https://www.threads.net/@link_english.pt?igshid=NTc4MTIwNjQ2YQ==" 
            target="_blank" 
            rel="noopener noreferrer"
            title="Threads"
            style={{ 
      ...
      {/* Versão mobile - links sociais empilhados */}
      <style jsx>{`
        ...
        @media (max-width: 480px) {
          ...
          footer div[style*="gap: 0.75rem"] a {
            width: 2.25rem !important;
            height: 2.25rem !important;
          }
          
          footer div[style*="gap: 0.75rem"] a svg {
